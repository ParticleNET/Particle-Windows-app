...
// <license>
// http://www.galasoft.ch/license_MIT.txt
// </license>
...
namespace ParticleApp.Business
{
	...
	public class Ioc : ISimpleIoc
	{
		...
		/// must be returned.</typeparam>
		/// <returns>An instance of the given type.</returns>
		public TService GetInstanceWithoutCaching<TService>(Object argument)
		{
			var t = _interfaceToClassMap[typeof(TService)];
			return (TService)Activator.CreateInstance(t, argument); 
		}
